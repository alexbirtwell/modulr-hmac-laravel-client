...
class PageResponsePaymentResponse_ implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'content'     => '\AlexBirtwell\ModulrHmacLaravel\Model\PaymentResponse[]',
        'page'        => 'int',
        'size'        => 'int',
        'total_pages' => 'int',
        'total_size'  => 'int',
     ...
     * Sets content.
     *
     * @param \AlexBirtwell\ModulrHmacLaravel\Model\PaymentResponse[] $content List of responses on the current page
     *
     * @return $this
     */
